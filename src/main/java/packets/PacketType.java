...
public enum PacketType { //ChristmasTree™   ⛧   <-crown
    ...
    RESET_ENCHANTMENT_REROLL_COUNT(191, Outgoing, ResetEnchantmentRerollCountPacket::new),
              CREATE_PARTY_MESSAGE(200, Outgoing, CreatePartyMessagePacket::new),
               PARTY_ACTION_RESULT(204, Incoming, PartyActionResult::new),
             PARTY_INVITE_RESPONSE(209, Outgoing, PartyInviteResponse::new),
             INCOMING_PARTY_INVITE(208, Incoming, IncomingPartyInvite::new),
                      PARTY_ACTION(207, Outgoing, PartyAction::new),
        INCOMING_PARTY_MEMBER_INFO(210, Incoming, IncomingPartyMemberInfo::new),
                PARTY_MEMBER_ADDED(212, Incoming, PartyMemberAdded::new),
            ...
            PARTY_REQUEST_RESPONSE(217, Incoming, PartyRequestResponse::new),
                      OR_RECONNECT(218, Incoming, ForReconnectPacket::new),
